...
var kickertisch_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att("xmlns:atom", atomNS).att("xmlns:kickercheck", kickerNS)
    .ele(kickertisch_object)
    .end({
        pretty: true
    });

var turnier_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att("xmlns:atom", atomNS).att("xmlns:kickercheck", kickerNS)
    .ele(turnier_object)
...
var spielstand_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att("xmlns:atom", atomNS).att("xmlns:kickercheck", kickerNS)
...
var benutzer_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att('xmlns:atom', atomNS).att('xmlns:kickercheck', kickerNS)
    .ele(benutzer_object)
...
var lokalitaet_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att("xmlns:atom", atomNS).att("xmlns:kickercheck", kickerNS)
...
var match_template = builder.create('kickercheck', {
        version: '1.0',
        encoding: 'UTF-8'
    }).att("xmlns:atom", atomNS).att("xmlns:kickercheck", kickerNS)
    .ele(match_object)
                ...
                switch (acceptedTypes) {
                    case "application/atom+xml":
                        ...
                        client.hgetall('Benutzer ' + benutzerId, function(err, obj) {
                            ...
                            var benutzerZu = builder.create('kickercheck', {
                                    version: '1.0',
                                    encoding: 'UTF-8'
                                }).att('xmlns:atom', atomNS + ' ').att('xmlns:kickercheck', kickerNS + ' ')
                                .ele(obj)
...
app.delete('/Turnier/:TurnierId', function(req, res) {
            ...
            if (contentType != "application/atom+xml") {
                ...
                client.exists('Turnier ' + turnierId, function(err, IdExists) {
                            ...
                            if (!IdExists) {
                            ...
                            } else { >>> >>> > eb762889fea2baad1f2bb7c456716e27ffe98945
                                ...
                                /*
                                 ...
                                 {'Datum':req.body.kickercheck.Datum,'Uhrzeit':req.body.kickercheck.Uhrzeit});
